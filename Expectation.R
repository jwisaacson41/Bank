expectation<-function(throw){
  ...
  dice_outcomes$total1_3<-ifelse(dice_outcomes$d1+dice_outcomes$d2==7
                                 , 70
                                 , dice_outcomes$d1+dice_outcomes$d2)
  
  dice_outcomes$total4<-ifelse(dice_outcomes$d1+dice_outcomes$d2==7
                               , 0
                               , dice_outcomes$d1+dice_outcomes$d2)
  
  dice_outcomes$double<-ifelse(dice_outcomes$d1==dice_outcomes$d2
                               , 1
                               , 0)
